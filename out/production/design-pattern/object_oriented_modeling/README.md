...
* ex) 이름, 전공, 학번, 과목 등
  ...
  > 수강 신청 시스템의 학생 클래스를 클래스 다이어그램을 사용해서 설계한 것이다.
...
<img src="../../capture/스크린샷 2019-07-23 오후 11.55.49.png">
...
* **연관 클래스** 
  ...
  * **연관 클래스를 일반 클래스로 변환한 예**
  ...
  <img src="../../capture/스크린샷 2019-07-23 오후 3.08.22.png">
